source("Master.R")
#1A: pies of missense and LoF constraint of OMIM and non-OMIM genes
...
a<- a+ggtitle(paste("OMIM genes"))+theme(plot.title = element_text(size = 20, face = "bold"),legend.position="none",legend.text=element_text(size=16))
...
b<- b+ggtitle(paste("Non-OMIM genes"))+theme(plot.title = element_text(size = 20, face = "bold"),legend.position="none",legend.text=element_text(size=16))
...
c<- c+ggtitle(paste("OMIM genes"))+theme(plot.title = element_text(size = 20, face = "bold"),legend.position="none",legend.text=element_text(size=16))
...
d<- d+ggtitle(paste("Non-OMIM genes"))+theme(plot.title = element_text(size = 20, face = "bold"),legend.position="none",legend.text=element_text(size=16))

ggarrange(
  ggarrange(a,b,common.legend=TRUE,legend="bottom"),
  ggarrange(c,d,common.legend=TRUE,legend="bottom"),nrow=2
)
ggsave("Sandra_Figures/Figs/fig1a.pdf",height=10, width=8, units='in')
dev.off()
...
ggsave("Sandra_Figures/Figs/fig1bi.pdf",height=5, width=5, units='in')
...
ggsave("Sandra_Figures/Figs/fig1bii.pdf",height=5, width=5, units='in')
...
ggsave("Sandra_Figures/Figs/fig1ci.pdf",height=6.5, width=6.5, units='in')
...
ggsave("Sandra_Figures/Figs/fig1cii.pdf",height=6.5, width=6.5, units='in')
