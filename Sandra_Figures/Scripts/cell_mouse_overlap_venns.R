...
mouse=textGrob("Mouse Lethal", gp=gpar(fontsize=16,fontfamily="Avenir"))
cell=textGrob("Cell Essential", gp=gpar(fontsize=16,fontfamily="Avenir"))
title3=textGrob("Cutoff at 3 cell lines", gp=gpar(fontsize=20,fontfamily="Avenir"))
a3=draw.pairwise.venn(area1 = length(which(universe_df$lethal_mouse=="N"&universe_df$cell_essential_hits>=3))+length(which(universe_df$lethal_mouse=="Y"&universe_df$cell_essential_hits>=3)), area2 = length(which(universe_df$lethal_mouse=="Y"&universe_df$cell_essential_hits<3))+length(which(universe_df$lethal_mouse=="Y"&universe_df$cell_essential_hits>=3)), cross.area=length(which(universe_df$lethal_mouse=="Y"&universe_df$cell_essential_hits>=3)), category = c("", ""), lty = "blank", 
                      fill = c("indianred2", "steelblue2"), euler.d = TRUE, scaled = TRUE,cat.default.pos='outer',cex=c(1.5,1.5,1.5),fontfamily="Avenir",alpha=0.8)
...
title2=textGrob("Cutoff at 2 cell lines", gp=gpar(fontsize=20,fontfamily="Avenir"))
...
title1=textGrob("Cutoff at 1 cell lines", gp=gpar(fontsize=20,fontfamily="Avenir"))
...
title4=textGrob("Cutoff at 4 cell lines", gp=gpar(fontsize=20,fontfamily="Avenir"))
...
title5=textGrob("Cutoff at 5 cell lines", gp=gpar(fontsize=20,fontfamily="Avenir"))
...
title6=textGrob("Cutoff at 6 cell lines", gp=gpar(fontsize=20,fontfamily="Avenir"))
...
title7=textGrob("Cutoff at 7 cell lines", gp=gpar(fontsize=20,fontfamily="Avenir"))
...
title8=textGrob("Cutoff at 8 cell lines", gp=gpar(fontsize=20,fontfamily="Avenir"))
...
title9=textGrob("Cutoff at 9 cell lines", gp=gpar(fontsize=20,fontfamily="Avenir"))
...
title10=textGrob("Cutoff at 10 cell lines", gp=gpar(fontsize=20,fontfamily="Avenir"))
...
title11=textGrob("Cutoff at 11 cell lines", gp=gpar(fontsize=20,fontfamily="Avenir"))
...
title12=textGrob("Cutoff at 12 cell lines", gp=gpar(fontsize=20,fontfamily="Avenir"))
...
title13=textGrob("Cutoff at 13 cell lines", gp=gpar(fontsize=20,fontfamily="Avenir"))
