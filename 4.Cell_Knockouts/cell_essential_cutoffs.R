...
cell_line_cutoff_numbers <- lapply(cell_line_cutoff_levels,function(x) length(which(cell_KOs$no_hits >= x)))

plot(cell_line_cutoff_levels,cell_line_cutoff_numbers)
