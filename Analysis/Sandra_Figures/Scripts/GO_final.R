...
slimshadyBP <- slimshadyBP[order(slimshadyBP$odds_ratio),]
#plotting heat map
ggplot(data = slimshadyBP, aes(x= gene,y = go_term)) +
...
ggsave("Analysis/Sandra_Figures/Figs/human_lethal_domrec_BP_MC_final.pdf",height=11, width=5.9, units='cm')
...
slimshadyMF <- slimshadyMF[order(slimshadyMF$odds_ratio),]
#plotting heat map
ggplot(data = slimshadyMF, aes(x= gene,y = go_term)) +
  geom_tile(aes(fill = odds_ratio,width=1)) +
  scale_fill_gradient2(low = "#a020f0",mid="white",high = "#008b45" ,trans="log",
                       breaks=c(min(slimshadyMF$odds_ratio),1,max(slimshadyMF$odds_ratio)),
                       labels=c("Enriched in RECESSIVE human lethal genes","","enriched in DOMINANT human lethal genes"))+
  bar_theme()+theme(axis.text.x=element_blank(),axis.title.y=element_blank(),legend.position = 'none',axis.text.y=element_text(size=12))+scale_y_discrete(expand = c(0, 0),labels = function(x) lapply(strwrap(x, width = 15, simplify = FALSE), paste, collapse="\n"))+scale_x_discrete(expand = c(0, 0))
ggsave("Analysis/Sandra_Figures/Figs/human_lethal_domrec_MF_MC_final.pdf",height=11, width=5.9, units='cm')
...
ggplot(data = slimshadyMF, aes(x= gene,y = go_term)) +
  ...
  scale_fill_gradient2(low = "#a020f0",mid="white",high = "#008b45" ,trans="log",
                       breaks=c(min(slimshadyMF$odds_ratio),1,max(slimshadyMF$odds_ratio)),
                       labels=c("Enriched in RECESSIVE human lethal genes","","enriched in DOMINANT human lethal genes"))+
  bar_theme()+theme(axis.text.x=element_blank(),axis.title.y=element_blank(),axis.text.y=element_text(size=12))+scale_y_discrete(expand = c(0, 0),labels = function(x) lapply(strwrap(x, width = 15, simplify = FALSE), paste, collapse="\n"))+scale_x_discrete(expand = c(0, 0))
ggsave("Analysis/Sandra_Figures/Figs/go_legend.pdf",height=11, width=5.9, units='cm')
...
#plotting heat map
ggplot(data = slimshadyCC, aes(x= gene,y = go_term)) +
  geom_tile(aes(fill = odds_ratio,width=1)) +
  scale_fill_gradient2(low = "#a020f0",mid="white",high = "#008b45" ,trans="log",
                       breaks=c(min(slimshadyCC$odds_ratio),1,max(slimshadyCC$odds_ratio)),
                       labels=c("Enriched in RECESSIVE human lethal genes","","enriched in DOMINANT human lethal genes"))+
  bar_theme()+theme(axis.text.x=element_blank(),axis.title.y=element_blank(),legend.position = 'none',axis.text.y=element_text(size=12))+scale_y_discrete(expand = c(0, 0),labels = function(x) lapply(strwrap(x, width = 2, simplify = FALSE), paste, collapse="\n"))+scale_x_discrete(expand = c(0, 0))
ggsave("Analysis/Sandra_Figures/Figs/human_lethal_domrec_CC_MC_final.pdf",height=11, width=5.9, units='cm')
...
#plotting heat map
ggplot(data = slimshadyBPput, aes(x= gene,y = go_term)) +
  geom_tile(aes(fill = odds_ratio,width=1)) +
  scale_fill_gradient2(low = "#a020f0",mid="white",high = "#008b45",trans="log",
  ...
  bar_theme()+theme(axis.text.x=element_blank(),axis.title.y=element_blank(),legend.position = 'none',axis.text.y=element_text(size=12))+scale_y_discrete(expand = c(0, 0),labels = function(x) lapply(strwrap(x, width = 20, simplify = FALSE), paste, collapse="\n"))+scale_x_discrete(expand = c(0, 0))
ggsave("Analysis/Sandra_Figures/Figs/PUTATIVE_domrec_BP_MC_final.pdf",height=11, width=5.9, units='cm')
...
#plotting heat map
ggplot(data = slimshadyMFput, aes(x= gene,y = go_term)) +
  geom_tile(aes(fill = odds_ratio,width=1)) +
  scale_fill_gradient2(low = "#a020f0",mid="white",high = "#008b45",trans="log",
                       breaks=c(min(slimshadyMFput$odds_ratio),1,max(slimshadyMFput$odds_ratio)),
                       labels=c("Enriched in RECESSIVE human lethal genes","","enriched in DOMINANT human lethal genes"))+
  bar_theme()+theme(axis.text.x=element_blank(),axis.title.y=element_blank(),axis.text.y=element_text(size=12),legend.position = 'none')+scale_y_discrete(expand = c(0, 0),labels = function(x) lapply(strwrap(x, width = 3, simplify = FALSE), paste, collapse="\n"))+scale_x_discrete(expand = c(0, 0))
ggsave("Analysis/Sandra_Figures/Figs/PUTATIVE_domrec_MF_MC_final.pdf",height=11, width=5.9, units='cm')
...
#plotting heat map
ggplot(data = slimshadyCCput, aes(x= gene,y = go_term)) +
  geom_tile(aes(fill = odds_ratio,width=1)) +
  scale_fill_gradient2(low = "#a020f0",mid="white",high = "#008b45",trans="log",
                       breaks=c(min(slimshadyCCput$odds_ratio),1,max(slimshadyCCput$odds_ratio)),
                       labels=c("Enriched in RECESSIVE human lethal genes","","enriched in DOMINANT human lethal genes"))+  
  bar_theme()+theme(axis.text.x=element_blank(),axis.title.y=element_blank(),legend.position = 'none',axis.text.y=element_text(size=12))+scale_y_discrete(expand = c(0, 0),labels = function(x) lapply(strwrap(x, width = 2, simplify = FALSE), paste, collapse="\n"))+scale_x_discrete(expand = c(0, 0))
ggsave("Analysis/Sandra_Figures/Figs/PUTATIVE_domrec_CC_MC_final.pdf",height=11, width=5.9, units='cm')
