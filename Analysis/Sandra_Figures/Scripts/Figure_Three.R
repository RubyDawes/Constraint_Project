...
inh_mis_human_lethal <- data.frame(MT=c(length(which(grepl(pattern="MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&universe_df$mis_z>=3.09))/length(which(grepl(pattern="MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&!is.na(universe_df$exac))),
                                        length(which(grepl(pattern="MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&universe_df$mis_z<3.09))/length(which(grepl(pattern="MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&!is.na(universe_df$exac)))),
                                   AR=c(length(which(universe_df$lethal_inheritance=="AR"&universe_df$human_lethal=="Y"&universe_df$mis_z>=3.09))/length(which(universe_df$lethal_inheritance=="AR"&universe_df$human_lethal=="Y"&!is.na(universe_df$exac))),
                                        length(which(universe_df$lethal_inheritance=="AR"&universe_df$human_lethal=="Y"&universe_df$mis_z<3.09))/length(which(universe_df$lethal_inheritance=="AR"&universe_df$human_lethal=="Y"&!is.na(universe_df$exac)))),
                                   "ARAD"=c(length(which(universe_df$lethal_inheritance=="AR,AD"&universe_df$human_lethal=="Y"&universe_df$mis_z>=3.09))/length(which(universe_df$lethal_inheritance=="AR,AD"&universe_df$human_lethal=="Y"&!is.na(universe_df$exac))),
                                            length(which(universe_df$lethal_inheritance=="AR,AD"&universe_df$human_lethal=="Y"&universe_df$mis_z<3.09))/length(which(universe_df$lethal_inheritance=="AR,AD"&universe_df$human_lethal=="Y"&!is.na(universe_df$exac)))),
                                   AD=c(length(which(universe_df$lethal_inheritance=="AD"&universe_df$human_lethal=="Y"&universe_df$mis_z>=3.09))/length(which(universe_df$lethal_inheritance=="AD"&universe_df$human_lethal=="Y"&!is.na(universe_df$exac))),
                                        length(which(universe_df$lethal_inheritance=="AD"&universe_df$human_lethal=="Y"&universe_df$mis_z<3.09))/length(which(universe_df$lethal_inheritance=="AD"&universe_df$human_lethal=="Y"&!is.na(universe_df$exac)))),
                                   XL=c(length(which(grepl("XL",universe_df$lethal_inheritance)&!grepl("MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&universe_df$mis_z>=3.09))/length(which(grepl("XL",universe_df$lethal_inheritance)&!grepl("MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&!is.na(universe_df$exac))),
                                        length(which(grepl("XL",universe_df$lethal_inheritance)&!grepl("MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&universe_df$mis_z<3.09))/length(which(grepl("XL",universe_df$lethal_inheritance)&!grepl("MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&!is.na(universe_df$exac)))))
...
inh_lof_human_lethal <- data.frame(MT=c(length(which(grepl(pattern="MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&universe_df$pLI>=0.9))/length(which(grepl(pattern="MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&!is.na(universe_df$exac))),
                                        length(which(grepl(pattern="MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&universe_df$pLI<0.9))/length(which(grepl(pattern="MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&!is.na(universe_df$exac)))),
                                   AR=c(length(which(universe_df$lethal_inheritance=="AR"&universe_df$human_lethal=="Y"&universe_df$pLI>=0.9))/length(which(universe_df$lethal_inheritance=="AR"&universe_df$human_lethal=="Y"&!is.na(universe_df$exac))),
                                        length(which(universe_df$lethal_inheritance=="AR"&universe_df$human_lethal=="Y"&universe_df$pLI<0.9))/length(which(universe_df$lethal_inheritance=="AR"&universe_df$human_lethal=="Y"&!is.na(universe_df$exac)))),
                                   "ARAD"=c(length(which(universe_df$lethal_inheritance=="AR,AD"&universe_df$human_lethal=="Y"&universe_df$pLI>=0.9))/length(which(universe_df$lethal_inheritance=="AR,AD"&universe_df$human_lethal=="Y"&!is.na(universe_df$exac))),
                                            length(which(universe_df$lethal_inheritance=="AR,AD"&universe_df$human_lethal=="Y"&universe_df$pLI<0.9))/length(which(universe_df$lethal_inheritance=="AR,AD"&universe_df$human_lethal=="Y"&!is.na(universe_df$exac)))),
                                   AD=c(length(which(universe_df$lethal_inheritance=="AD"&universe_df$human_lethal=="Y"&universe_df$pLI>=0.9))/length(which(universe_df$lethal_inheritance=="AD"&universe_df$human_lethal=="Y"&!is.na(universe_df$exac))),
                                        length(which(universe_df$lethal_inheritance=="AD"&universe_df$human_lethal=="Y"&universe_df$pLI<0.9))/length(which(universe_df$lethal_inheritance=="AD"&universe_df$human_lethal=="Y"&!is.na(universe_df$exac)))),
                                   XL=c(length(which(grepl("XL",universe_df$lethal_inheritance)&!grepl("MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&universe_df$pLI>=0.9))/length(which(grepl("XL",universe_df$lethal_inheritance)&!grepl("MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&!is.na(universe_df$exac))),
                                        length(which(grepl("XL",universe_df$lethal_inheritance)&!grepl("MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&universe_df$pLI<0.9))/length(which(grepl("XL",universe_df$lethal_inheritance)&!grepl("MT",universe_df$lethal_inheritance)&universe_df$human_lethal=="Y"&!is.na(universe_df$exac)))))
