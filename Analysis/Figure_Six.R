#6A: Odds ratio (OR) analysis linking disease involvement to murine and cellular non-viability ####
...
#6B: Odds ratio (OR) analysis linking LETHAL disease involvement to murine and cellular non-viability ####
...
e<-ggplot(lethal_metrics_ADXLD_OR) +
  geom_bar( aes(x=categories, y=OR), stat="identity", fill=c("indianred3","black","sandybrown")) +
  geom_errorbar( aes(x=categories, ymin=confint_lower, ymax=confint_upper), width=0.2, colour="grey40", alpha=0.9, size=1)+
  bar_theme()+geom_hline(yintercept=1)+xlab("")+
...
f<-ggplot(lethal_metrics_ARMTXLR_OR) +
  geom_bar( aes(x=categories, y=OR), stat="identity", fill=c("indianred3","black","sandybrown")) +
  geom_errorbar( aes(x=categories, ymin=confint_lower, ymax=confint_upper), width=0.2, colour="grey40", alpha=0.9, size=1)+
  bar_theme()+geom_hline(yintercept=1)+xlab("")+
